...
import {JobExperiencesComponent} from '../component/job-experiences/job-experiences.component';
...
export class AppComponent implements AfterViewInit {
  ...
  checkMobileView() {
    ...
    console.log('this.isMobile', this.isMobileView)
  }
  ...
  updateContentWidth() {
    ...
    if (container) {
      // Sesuaikan navigasi dengan lebar konten
      this.contentWidth = container.offsetWidth;
    } else {
      // Default jika kontainer tidak ditemukan
      this.contentWidth = 360; // default width
    }
  }
